# current version, have the user pass in the scenes for the purpose of demo...
...
def generate_from_perplexity_json(
    ...
    return generate_heygen_video_v1_from_body(body=body, output_path=output_path)


def generate_heygen_video_v1_from_body(
    body: dict,
    output_path: str,
    poll_interval: int = 5,
):
